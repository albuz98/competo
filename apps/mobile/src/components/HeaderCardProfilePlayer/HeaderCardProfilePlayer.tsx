...
import { styles } from "./HeaderCardProfilePlayer.styled";
...
interface HeaderCardProfilePlayerProps {
  user: User | null;
...
export const HeaderCardProfilePlayer = ({
  user,
  avatarProfile,
  displayName,
  subtitle,
