export const mockFlags = {
  ...
  IS_MOCKING_FETCH_TEAM_DETAIL: true,
  //patch - Update team
  IS_MOCKING_DELETE_TEAM: true,
  IS_MOCKING_FETCH_TEAM_MEMBERS: true,
  IS_MOCKING_LEAVE_TEAM: true,
  IS_MOCKING_GET_TEAM_INVITATIONS: true,
  ...
  IS_MOCKING_FETCH_TEAM_STATS: true,
  IS_MOCKING_FETCH_TEAM_GOAL_SCORERS: true,
  IS_MOCKING_FETCH_TEAM_TOURNAMENTS: true,
